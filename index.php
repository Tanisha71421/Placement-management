					...
					<div class="top-nav">
						...
						<ul class="nav1">
							<li class="hvr-sweep-to-bottom">
								<a href="http://127.0.0.1/Placement%20Management%20System%20in%20PHP/homepage/home.php">PW-PMS<i>Goto Placement Homepage</i></a>
							</li>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Address</h3>
					<div class="address">
						<p>MIT Academy Of Engineering,Dehu Phata,Alandi(D)
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Copyright@ &copy; TS2538 @2020 MIT Academy of Engineering | Developed by
              <a href="http://www.mitaoe.ac.in/about-mit.php" target="_parent">MIT GROUP</a>
				</div>
