		...
		<div class="container">
			...
			<div class="mail-grids">
				<div class="col-md-6 mail-grid-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<p>Dehu Phata,Alandi(D)</P>
						<span>PUNE(412105),Maharashtra(India)</span>
					</p>
					<h4>Get In Touch</h4>
					<p>Telephone: 020-30253500,30253600,8793323500
						<span>FAX: (020) 30253799</span>
						E-mail: <a href="mailto:citcollege@rediffmail.com">MITGROUP@gmail.com</a>
					</p>
				</div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Address</h3>
					<div class="address">
						<p>Dehu Phata,Alandi(D)
							<span>PUNE(412105),Maharashtra(India)</span>
						</p>
					</div>
					<div class="phone">
						<p>020-30253500,30253600,8793323500</p>
					</div>
				</div>
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">MIT Academy of Engineering</h6>
					<h4>
						<a href="../Homepage/index.php" style="color: white">MITAOE Placement Portal</a>
					</h4>
					<p></p>
				</div>
				<div class="clearfix"></div>
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Copyright TS2538 &copy; 2020 MIT Academy of Engineering | Developed by
              <a href="http://PROJECTWORLDS.IN" target="_parent">MIT GROUP</a>
				</div>
